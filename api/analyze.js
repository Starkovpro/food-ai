export default async function handler(req, res) {
  ...
  const { type, imageBase64, ingredients } = req.body;
  ...
  if (type === 'calories') {
    ...
    messages = [{
      ...
      content: [
        ...
        {
          type: 'text',
          text: 'Ты диетолог и нутрициолог. Внимательно посмотри на фото и определи что за блюдо или продукты изображены. Затем:\n1. Назови блюдо/продукты\n2. Оцени примерную калорийность (ккал) для порции на фото\n3. Укажи приблизительное содержание белков, жиров и углеводов\n4. Дай краткую заметку о пищевой ценности\n\nЕсли на фото нет еды, скажи об этом.\n\nФормат: начни ответ с числа калорий вот так: ККАЛ: [число], затем с новой строки дай полный анализ.'
        }
      ]
    }];
  } else if (type === 'recipe') {
